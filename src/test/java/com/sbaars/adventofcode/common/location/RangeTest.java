...
public class RangeTest {
  ...
  public void intersectsWith1() {
    ...
    assertEquals(new Loc(2, 2), range3.intersectsWith(range4).get());
    assertEquals(new Loc(2, 2), range4.intersectsWith(range3).get());
  }
  ...
  public void intersectsWith2() {
    ...
    assertEquals(new Loc(1, 1), range5.intersectsWith(range6).get());
    assertEquals(new Loc(1, 1), range6.intersectsWith(range5).get());
  }
  ...
  public void intersectsWith3() {
    ...
    assertEquals(new Loc(1, 2), range5.intersectsWith(range7).get());
    assertEquals(new Loc(1, 2), range7.intersectsWith(range5).get());
  }
  ...
  public void intersectsWith4() {
    ...
    assertEquals(new Loc(1, 3), range5.intersectsWith(range8).get());
    assertEquals(new Loc(1, 3), range8.intersectsWith(range5).get());
  }
}
